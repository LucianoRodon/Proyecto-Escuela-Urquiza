...
const Header = () => {
  const { user, token, setUserHeader, notification, updateNotification } =
    useStateContext();
  ...
  const fetchNotifications = async () => {
    try {
      ...
      if (newNotifications.length > 0) {
        const hasShownModalBefore = sessionStorage.getItem(
          "hasShownNotificationModal"
        );
                        ...
                        ? students.map((notification) => (
                            ...
                            >
                              <li className={styles.liNotifications}>
                                ...
                                <div>
                                  {notification.name} quiere ingresar al
                                  sistema.
                                </div>
                              </li>
                            </Link>
